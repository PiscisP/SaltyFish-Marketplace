...
INSERT INTO `school_commodity` VALUES (5, 'A fancy tea cup, orginal price is 23, a great deal right now', 'tea cups', '6', 'https://m.media-amazon.com/images/I/61pFP3+lrPL.jpg', 1.50, '2023-11-24 09:32:00', 'SCUXXXXXXXX', 5, 1, 'yuumi', 1);
INSERT INTO `school_commodity` VALUES (6, 'A fancy tea cup, orginal price is 23, a great deal right now', 'tea cups', '6', 'https://m.media-amazon.com/images/I/61pFP3+lrPL.jpg', 1.50, '2023-11-24 09:32:01', 'SCUXXXXXXXX', 5, 1, 'yuumi', 1);
INSERT INTO `school_commodity` VALUES (7, 'A fancy tea cup, orginal price is 23, a great deal right now', 'tea cups', '6', 'https://m.media-amazon.com/images/I/61pFP3+lrPL.jpg', 1.50, '2023-11-24 09:32:01', 'SCUXXXXXXXX', 5, 1, 'yuumi', 1);
INSERT INTO `school_commodity` VALUES (8, 'A fancy tea cup, orginal price is 23, a great deal right now', 'tea cups', '6', 'https://m.media-amazon.com/images/I/61pFP3+lrPL.jpg', 1.50, '2023-11-24 09:32:02', 'SCUXXXXXXXX', 5, 1, 'yuumi', 1);
...
INSERT INTO `school_commodity` VALUES (10, 'exercise bike, spend thousands dollars before, want to buy a new one, have orignial receipt', 'second hand exercise bike', '2', 'https://m.media-amazon.com/images/I/71PVBwDOTAL._AC_UF1000,1000_QL80_.jpg', 500.00, '2023-11-24 09:32:03', 'san jose', 7, 1, 'Andy', 0);
INSERT INTO `school_commodity` VALUES (11, 'exercise bike, spend thousands dollars before, want to buy a new one, have orignial receipt', 'second hand exercise bike', '2', 'https://m.media-amazon.com/images/I/71PVBwDOTAL._AC_UF1000,1000_QL80_.jpg', 500.00, '2023-11-24 09:31:43', 'san jose', 7, 0, 'Andy', 1);
INSERT INTO `school_commodity` VALUES (12, 'exercise bike, spend thousands dollars before, want to buy a new one, have orignial receipt', 'second hand exercise bike', '2', 'https://m.media-amazon.com/images/I/71PVBwDOTAL._AC_UF1000,1000_QL80_.jpg', 500.00, '2023-11-24 09:32:04', 'san jose', 7, 1, 'Andy', 0);
...
INSERT INTO `school_commodity` VALUES (15, 'children gamepad, more than 5000 child game', 'gamepad', '5', 'https://m.media-amazon.com/images/I/71WzEVtX4yL._AC_UF894,1000_QL80_.jpg', 12.00, '2023-11-24 09:32:05', 'SJSU', 6, 1, 'Mia', 1);
INSERT INTO `school_commodity` VALUES (16, 'children gamepad, more than 5000 child game', 'gamepad', '5', 'https://m.media-amazon.com/images/I/71WzEVtX4yL._AC_UF894,1000_QL80_.jpg', 12.00, '2023-11-24 09:31:47', 'SJSU', 6, 0, 'Mia', 1);
...
INSERT INTO `school_commodity` VALUES (22, 'League of Lengends skins', 'phone：26626996', '1', 'https://images.contentstack.io/v3/assets/blt731acb42bb3d1659/bltbedb65d3a38fd1a8/641a548b00554e3ab2c5f053/LOL_FC_KARMA_TEXTLESS_1920x1080_JDiaz_V001.jpg', 33.00, '2023-11-23 17:03:59', 'SCUXXX', 7, 1, 'Mr.good', 1);
...
-- ----------------------------
-- Table structure for school_login
-- ----------------------------
...
CREATE TABLE `school_message`  (
  ...
  CONSTRAINT `userid` FOREIGN KEY (`userid`) REFERENCES `school_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of school_message
-- ----------------------------
INSERT INTO `school_message` VALUES (3, 7, 'OK', '2023-11-24 23:59:29');
INSERT INTO `school_message` VALUES (6, 7, 'Ok', '2023-11-24 23:59:29');
INSERT INTO `school_message` VALUES (7, 7, 'product delete：reason：No such phone number', '2022-04-25 00:50:06');
INSERT INTO `school_message` VALUES (8, 7, 'product delete: reason: wrong info', '2022-04-25 00:52:36');
INSERT INTO `school_message` VALUES (9, 7, 'delete wants: ', '2022-04-25 00:58:11');
INSERT INTO `school_message` VALUES (10, 7, 'delete wants', '2022-04-25 00:59:32');
...
-- ----------------------------
INSERT INTO `school_need` VALUES (1, 'Lee', 'earpods', '666room', 5, '2023-11-25 12:17:57', 1);
...
-- ----------------------------
INSERT INTO `school_user` VALUES (1, 'aa12345678', 0, 18, 'Standford', '18012414215', 'I am a rocker', '93f628b5ba5e1ebcb02e88cd7f8587d2', '2022-04-16 23:55:24', '2023-11-23 20:18:03');
